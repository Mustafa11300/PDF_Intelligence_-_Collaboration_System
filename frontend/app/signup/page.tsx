...
export default function SignupPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await login(form.email, form.password); // signup doesn't return a token, so log in right after
      ...
      <div className="relative w-full max-w-md mx-auto px-4">
        ...
        >
          <div className="mb-8">
            ...
            <p style={{ color: "#64748b", fontSize: 14 }}>Get started with PDF Intelligence.</p>
          </div>
